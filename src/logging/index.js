...
function Success(...args) {
  ...
  if(DebugMode) {
    ...
    console.log(`\x1b[42m\x1b[37m[i - ${currentTime} - ${tracking}]\x1b[0m\x1b[32m ${data}\x1b[0m`);
  } else console.log(`\x1b[0m\x1b[32m${data}\x1b[0m`);
}
...
function Info(...args) {
  ...
  } else console.log(`\x1b[0m\x1b[36m${data}\x1b[0m`);
}
